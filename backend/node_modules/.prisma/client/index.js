...
const config = {
  ...
  "inlineSchema": "// prisma/schema.prisma\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"postgresql\" // OU mysql, sqlite - TEM QUE SER IGUAL AO QUE VOCÊ USOU NO \"prisma init\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        String   @id @default(uuid())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "19379fa2558e059c387b5047b6caa957342cc5de05a90d7d3b31c73bf41a0dac",
  "copyEngine": true
}
